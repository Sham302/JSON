...
public class StudentDTO {
    ...
    public String getFirstName (){ return (String) student.get("firstName"); }

    public String getLastName(){ return (String) student.get("lastName"); }

    public String getDegree(){ return (String) student.get("degree"); }

    public Long getAge(){ return (Long) student.get("age"); }
}
